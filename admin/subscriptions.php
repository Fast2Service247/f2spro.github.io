		...
		<div class="page-wrapper">
			<div class="content container-fluid">
				...
				<div class="page-header">
					<div class="row">
						...
						<div class="col-auto text-right">
							<a href="add-subscription.php" class="btn btn-primary add-button">
				...
				<?php
                    ...
                    $qry="select * from subscription ORDER BY id DESC";
                                ...
                                $subscription_durations=$row['subscription_durations'];
						...
						<div class="card">
							<div class="card-body">
								<div class="pricing-header">
									<h2><?php echo $subscription_name; ?></h2>
									<p>Monthly Price</p>
								</div>
								<div class="pricing-card-price">
									<h3 class="heading2 price">$<?php echo $subscription_amount; ?></h3>
									<p>Duration: <span><?php echo $subscription_durations; ?></span></p>
								</div>
								<ul class="pricing-options">
									<li><i class="far fa-check-circle"></i> One listing submission</li>
									<li><i class="far fa-check-circle"></i> <?php echo $subscription_durations; ?> expiration</li>
								</ul>
								<a href="edit-subscription.php" class="btn btn-primary btn-block">Edit</a>
							</div>
						</div>
					</div>
