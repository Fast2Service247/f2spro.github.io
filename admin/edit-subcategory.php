...
$sql = "update subcategory set category='".$_POST['category']."',sub_category_name='".$_POST['sub_category_name']."',sub_category_image='".$_FILES["sub_category_image"]["name"]."'where id='".$id."'";
// Execute query 
mysqli_query($conn, $sql);
move_uploaded_file($_FILES["sub_category_image"]["tmp_name"],"images/".$_FILES["sub_category_image"]["name"]);
						...
						<div class="card">
							...
							<form action="" method="post" enctype="multipart/form-data">
									<div class="form-group">
										...
										<select class="form-control select" name="" value="<?php echo $category; ?>" required>
									...
									<div class="form-group">
										...
										<input class="form-control" type="text" name="sub_category_name" value="<?php echo $sub_category_name; ?>" required>
									</div>
									<div class="form-group">
										<label>Category Image</label>
										<input class="form-control" type="file" name="sub_category_image" value="<?php echo $sub_category_image; ?>" required>
									</div>
									<div class="form-group">
										<div class="avatar">
											<img class="avatar-img rounded" alt="" src="images/<?php echo $sub_category_image; ?>">
										</div>
									</div>
									<div class="mt-4">
										<button class="btn btn-primary" type="submit" name="edit_subcategory">Save Changes</button>
