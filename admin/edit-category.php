...
$sql = "update category set category_name='".$_POST['category_name']."',category_image='".$_FILES["category_image"]["name"]."'where id='".$id."'";
// Execute query 
							...
							<div class="card-body">
								...
								<form action="" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<input class="form-control" type="file" name="category_image" value="<?php echo $category_image; ?>" required>
									</div>
									<div class="form-group">
										<div class="avatar">
									...
									<div class="mt-4">
										<button class="btn btn-primary" type="submit" name="edit-category">Save Changes</button>
