							...
							<div class="card-body">
								...
								<form method="post" action="database.php" enctype="multipart/form-data">
									<div class="form-group">
										...
										<input class="form-control" type="text" name="ratings_type" required>
									</div>
									<div class="mt-4">
										<button class="btn btn-primary" type="submit" name="ratingstype_submit">Submit</button>
										<a href="ratingstype.php" class="btn btn-link">Cancel</a>
									</div>
								</form>
								<!-- /Form -->
