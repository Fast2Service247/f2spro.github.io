							...
							<div class="card-body">
								...
								<form method="post" action="database.php" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<input class="form-control" type="file" name="sub_category_image" required>
									</div>
									<div class="mt-4">
										<button class="btn btn-primary" type="submit" name="subcategory_submit">Add Subcategory</button>
										<a href="subcategories.php" class="btn btn-link">Cancel</a>
									</div>
								</form>
								<!-- /Form -->
