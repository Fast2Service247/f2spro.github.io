										...
										<div class="item-info">
											<div class="service-user">
												<a href="javascript:void(0);">
													<img src="assets/img/provider/<?php echo $p_email; ?>" alt="">
												</a>
												<span class="service-price">$<?php echo $service_amount; ?></span>
											</div>
											<div class="cate-list">
												<a class="bg-yellow" href="service_details.php"><?php echo $title; ?></a>
											</div>
										</div>
									</div>
									<div class="service-content">
										...
										<div class="user-info">
											<div class="service-action">
												<div class="row">
													<div class="col">
														<a href="edit_service.php" class="text-success"><i class="far fa-edit"></i> Edit</a>
													</div>
