										...
										<a href="javascript:void(0);" class="media active">
											<div class="media-img-wrap">
												<div class="avatar avatar-away">
													<img src="assets/upload_img/<?php echo $p_image; ?>"  class="avatar-img rounded-circle">
												</div>
											</div>
											<div class="media-body">
												<div>
													<div class="user-name"><?php echo $p_name; ?></div>
								...
								<div class="card mb-0">
									...
									<div class="card-header msg_head">
										<div class="d-flex bd-highlight">
											...
											<div class="img_cont">
												<img class="rounded-circle user_img" src="assets/upload_img/<?php echo $p_image; ?>" alt="">
											</div>
											<div class="user_info">
												<span><strong id="receiver_name"><?php echo $p_name; ?></strong></span>
