...
<body>
	...
	<div class="main-wrapper">
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											...
											<input class="form-control" type="hidden" name="p_name" value="<?php echo $p_name;?>">
											<input class="form-control" type="hidden" name="p_email" value="<?php echo $p_email;?>">
											<input class="form-control" type="hidden" name="p_mobile_number" value="<?php echo $p_mobile_number;?>">
									...
									<div class="col-lg-6">
										<div class="form-group">
											...
											<input class="form-control" type="text" name="service_location" required>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="col-lg-6">
										<div class="form-group">
											...
											<select class="form-control" name="category" required>
												<!--<option>Massage Men</option>-->
            <!--                                    <option>Saloon Men</option> -->
            <!--                                    <option>Massage Women</option>-->
            <!--                                    <option>Saloon Women</option>-->
                                                <option>Products seller</option>
                                                <option>AC Service and Repair</option>
                                                <option>Appliance Repair</option>
                                                <option>Painters Service</option>
                                                <option>Cleaning and Disinfection</option>
                                                <option>Electricions Service</option>
                                                <option>Car Wach Service</option>
									...
									<div class="col-lg-6">
										<div class="form-group">
											...
											<option>Shop by products</option>
									...
									<div class="row form-row membership-cont">
										<div class="col-lg-6">
											<div class="form-group">
												...
												<input class="form-control" type="number" name="service_offered" required>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											...
											<textarea class="form-control service-desc" name="descriptions" required></textarea>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="submit-section">
								<button class="btn btn-primary submit-btn" type="submit" name="service_submit">Submit</button>
							</div>
						</form>
					</div>
				</div>
		...
		<footer class="footer">
			...
			<!--							</li>-->
			<!--							<li>-->
			<!--								<a href="https://www.instagram.com/fast2service" target="_blank"><i class="fab fa-instagram"></i>-->
			<!--							</li>-->
			<!--						</ul>-->
